...
class PluginPluginmanagerManager
{
    ...
    /**
     * Processar upload e instalar plugin
     */
    public static function processUpload($file)
    {
        ...
        try {
            ...
            $result['success'] = true;
            $result['message'] = "Plugin '$plugin_name' instalado com sucesso! Acesse Configuração > Plugins para ativá-lo.";
